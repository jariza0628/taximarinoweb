...
@Component({
  selector: 'app-comisions',
  templateUrl: './comisions.component.html',
  styleUrls: ['./comisions.component.css']
})
export class ComisionsComponent implements OnInit {
  ...
  getDataBydate(date?) {
    ...
    this._GeneralServiceService
      .getSaleBydate("commissions", "date", dateSelected)
      .subscribe((data) => {
