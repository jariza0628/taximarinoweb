...
@Component({
  selector: 'app-report-sales-auditoria',
  templateUrl: './report-sales-auditoria.component.html',
  styleUrls: ['./report-sales-auditoria.component.css']
})
export class ReportSalesAuditoriaComponent implements OnInit {
  data: Array<Sales>;
    ...
    switch (val) {
      case "totalreport":
        ...
        this.data.forEach((element) => {
          ...
          if(this.usuariosComision.includes(element.seller)){
