...
export class PlansComponent implements OnInit {
  ...
  constructor(private _GeneralServiceService: GeneralServiceService) {
    ...
    this._formEntity = new FormGroup({
      ...
      discount: new FormControl(0, [Validators.max(100), Validators.min(0)]),
      agency: new FormControl("", [Validators.maxLength(100)]),
  ...
  loadDataForm(dataToEdit: Plan) {
    ...
    this._formEntity = new FormGroup({
      ...
      agency: new FormControl(dataToEdit.agency, [Validators.maxLength(100)]),
      code: new FormControl("", [
        Validators.required,
        Validators.maxLength(3),
        Validators.minLength(2),
      ...
      services: new FormControl("", []),
      selectedDoor: new FormControl("", [Validators.maxLength(100)]),
    });
